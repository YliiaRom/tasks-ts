...
//     останній рядок
const btnTask14 = document.getElementById("btnTask14");
const solution14 = document.getElementById("solution14");
btnTask14 === null || btnTask14 === void 0 ? void 0 : btnTask14.addEventListener("click", () => {
    let stringCount = 0;
    let numCount = 0;
    let lastData = "";
    for (let i = 0; i < 10; i++) {
        const value = Math.random() > 0.5 ? "ok" : Math.floor(Math.random() * 100);
    ...
    let differens = differensVal > 0 ? "string" : "number";
